...
"Guru, hentikan guru, kami tidak ingin berdosa, guru" adalah potongan suara (sound) dan frasa jenaka yang sedang tular di media sosial seperti TikTok dan Reels sebagai latar audio parodi atau reaksi spontan.
...
`guru-laravel` forces the agent to:
...
```bash
npx skills add msulaimanmisri/sulaiman-agent-skills --skill guru-laravel
```

Installed into:

```text
.agents/skills/guru-laravel/
```
...
"/guru-laravel show to me how this button works"
...
Found a Laravel pattern this skill doesn't handle well? Open an issue or PR in the `sulaiman-agent-skills` repo.
